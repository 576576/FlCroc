...
class _SendViewState extends ConsumerState<SendView> with TickerProviderStateMixin {
  ...
  Future<void> _startSend() async {
    ...
    final options = SendOptions(
      ...
      codePhrase: code, sendingText: isText, textContent: isText ? textContent : '',
    ...
    coreController.sendFiles(options).listen(
      ...
      onDone: () { if (mounted && _phase != SendPhase.success) setState(() => _phase = SendPhase.fail); },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return CommonScaffold(
      ...
      actions: [
        ...
        FilledButtonWidget(
          onPressed: _phase == SendPhase.sending ? null : _startSend,
          text: l10n.startSend,
          icon: Icons.send,
        ),
        const SizedBox(width: 8),
