module github.com/flcroc/bridge

go 1.27.0

require github.com/schollz/croc/v11 v11.5.2
...
require (
	...
	gvisor.dev/gvisor v0.0.0-20260906120324-45bde0d1defa // indirect
	tailscale.com v1.102.3 // indirect
)

replace github.com/schollz/croc/v11 => ../submodules/croc
